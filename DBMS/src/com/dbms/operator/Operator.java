...
public interface Operator {
     ...
     * @return 成功 true 失败 false
     */
    boolean createTable(String dbName, String tableName, Data data, String primaryKey);
    ...
    String getString(String s, char ch);        //在s的两边加上ch

    String getType(String dbName, String tableName, String columnName);

    void PrintRes(ResultSet res);
}
